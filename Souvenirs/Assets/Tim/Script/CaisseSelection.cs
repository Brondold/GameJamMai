...
public class CaisseSelection : MonoBehaviour
{
    ...
    {
        if(gameObject == caisse_grenier_1 && caisse_grenier_2.activeInHierarchy && caisse_grenier_3.activeInHierarchy)
        {
            gameObject.SetActive(false);
            caisse_atelier_1.SetActive(true);

        }
        if(gameObject == caisse_grenier_2 && caisse_grenier_1.activeInHierarchy && caisse_grenier_3.activeInHierarchy)
        {
            gameObject.SetActive(false);
            caisse_atelier_2.SetActive(true);
        }
        if(gameObject == caisse_grenier_3 && caisse_grenier_1.activeInHierarchy && caisse_grenier_2.activeInHierarchy)
        {
            gameObject.SetActive(false);
